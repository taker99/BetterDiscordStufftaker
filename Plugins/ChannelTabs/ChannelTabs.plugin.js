...
module.exports = (() => {
	const config = {
		info: {
			...
			github:
				"https://github.com/samfundev/BetterDiscordStuff/blob/master/Plugins/ChannelTabs/",
			github_raw:
				"https://raw.githubusercontent.com/samfundev/BetterDiscordStuff/master/Plugins/ChannelTabs/ChannelTabs.plugin.js",
		},
	};
	...
	return !global.ZeresPluginLibrary
		...
		: (([Plugin, Api]) => {
				const plugin = (Plugin, Api) => {
					...
					const { ContextMenu, Patcher, Webpack, Plugins } = new BdApi(
						"ChannelTabs",
					);
					...
					const DiscordConstants = {
						ChannelTypes: getModule(byProps("GUILD_TEXT"), {
							searchExports: true,
						}),
					};
					const Textbox =
					...
					const NavShortcuts = getModule(
						byProps("NAVIGATE_BACK", "NAVIGATE_FORWARD"),
					);
					const TopbarSelector = getModule(byProps("app", "layers"), {
					...
					const LeftCaret =
						getModule(
							byStrings("18.35 4.35 16 2 6 12 16 22 18.35 19.65 10.717 12"),
						) ?? (() => React.createElement("b", null, "<"));
					const RightCaret =
						getModule(
							byStrings(
					...
					const DefaultUserIconGrey =
						"https://cdn.discordapp.com/embed/avatars/0.png";
					const DefaultUserIconGreen =
						"https://cdn.discordapp.com/embed/avatars/1.png";
					const DefaultUserIconBlue =
						"https://cdn.discordapp.com/embed/avatars/2.png";
					const DefaultUserIconRed =
						"https://cdn.discordapp.com/embed/avatars/3.png";
					const DefaultUserIconYellow =
			...
			<rect fill="var(--interactive-normal)" x="20" y="55" width="50" height="10"></rect>
										...
										},
										{
											...
											values: [
												...
												},
												{
													...
													color: "danger",
													action: () =>
														props.closeTab(props.tabIndex, "single"),
													items: mergeLists(
														{
															values: [
																{
																...
																},
																{
																	...
																	action: () =>
																		props.closeTab(props.tabIndex, "other"),
																	color: "danger",
																},
															],
														},
															...
															values: [
																{
																	...
																	action: () =>
																		props.closeTab(props.tabIndex, "right"),
																	color: "danger",
																},
															],
														},
															...
															values: [
																{
																	...
																	action: () =>
																		props.closeTab(props.tabIndex, "left"),
																	color: "danger",
																},
															],
														},
															...
															values: [
																{
																	...
																	color: "danger",
																	action: () =>
																		props.moveToFavGroup(props.favIndex, -1),
																},
																{
																	type: "separator",
																},
										...
										},
										{
											values: [
												...
												},
												{
													...
													id: "deleteGroup",
													action: () =>
														props.removeFavGroup(props.favGroup.groupId),
													color: "danger",
												},
											],
										},
												...
												items: [
													{
														...
														checked: () =>
															TopBarRef.current.state.reopenLastChannel,
														action: () => {
															instance.setState(
																{
																	reopenLastChannel:
																		!instance.state.reopenLastChannel,
																},
																() => {
											...
											},
											{
												...
												items: [
													...
													},
													{
														...
														id: "radialStatusMode",
														checked: () =>
															TopBarRef.current.state.radialStatusMode,
														action: () => {
															instance.setState(
																{
																	radialStatusMode:
																		!instance.state.radialStatusMode,
																},
																() => {
													...
													},
													{
														...
														color: "danger",
														checked: () =>
															TopBarRef.current.state.showQuickSettings,
														action: () => {
															instance.setState(
																{
																	showQuickSettings:
																		!instance.state.showQuickSettings,
																},
																() => {
													...
													},
													{
														...
														id: "showNavButtons",
														checked: () =>
															TopBarRef.current.state.showNavButtons,
														action: () => {
															instance.setState(
																{
																	showNavButtons:
																		!instance.state.showNavButtons,
																},
																() => {
												...
												items: [
													{
														...
														checked: () =>
															TopBarRef.current.state.alwaysFocusNewTabs,
														action: () => {
															instance.setState(
																{
																	alwaysFocusNewTabs:
											...
											},
											{
												...
												items: [
													...
													},
													{
														...
														id: "favs_Mentions",
														checked: () =>
															TopBarRef.current.state.showFavMentionBadges,
														action: () => {
															instance.setState(
																{
													...
													},
													{
														...
														id: "favs_Unreads",
														checked: () =>
															TopBarRef.current.state.showFavUnreadBadges,
														action: () => {
															instance.setState(
																{
																	showFavUnreadBadges:
													...
													},
													{
														...
														id: "favs_Typing",
														checked: () =>
															TopBarRef.current.state.showFavTypingBadge,
														action: () => {
															instance.setState(
																{
																	showFavTypingBadge:
													...
													},
													{
														...
														id: "favs_Empty",
														checked: () =>
															TopBarRef.current.state.showEmptyFavBadges,
														action: () => {
															instance.setState(
																{
																	showEmptyFavBadges:
													...
													},
													{
														...
														id: "tabs_Mentions",
														checked: () =>
															TopBarRef.current.state.showTabMentionBadges,
														action: () => {
															instance.setState(
																{
													...
													},
													{
														...
														id: "tabs_Unreads",
														checked: () =>
															TopBarRef.current.state.showTabUnreadBadges,
														action: () => {
															instance.setState(
																{
																	showTabUnreadBadges:
													...
													},
													{
														...
														id: "tabs_Typing",
														checked: () =>
															TopBarRef.current.state.showTabTypingBadge,
														action: () => {
															instance.setState(
																{
																	showTabTypingBadge:
													...
													},
													{
														...
														id: "tabs_Empty",
														checked: () =>
															TopBarRef.current.state.showEmptyTabBadges,
														action: () => {
															instance.setState(
																{
																	showEmptyTabBadges:
					...
					const getCurrentUserStatus = (pathname = location.pathname) => {
						const cId = (pathname.match(
							/^\/channels\/(\d+|@me|@favorites)\/(\d+)/,
						) || [])[2];
						if (cId) {
					...
					const getCurrentName = (pathname = location.pathname) => {
						...
						if (cId) {
							const channel = ChannelStore.getChannel(cId);
							if (channel?.name)
								return (channel.guildId ? "@" : "#") + channel.name;
							else if (channel?.rawRecipients)
								return channel.rawRecipients
									.map(
										(u) => RelationshipStore.getNickname(u.id) || u.globalName,
									)
									.join(", ");
					...
					const TabTypingBadge = ({ viewMode, isTyping, userIds }) => {
						...
						return React.createElement(
							...
							{
								className:
									"channelTabs-TypingContainer" +
									GetTabStyles(viewMode, "typingBadge"),
							},
							React.createElement(
								Tooltip,
								{
					...
					const FavMoveToGroupList = (props) => {
						var groups = props.favGroups.map((group, index) => {
							var entry = {
								...
								id: "entry" + index,
								action: () =>
									props.moveToFavGroup(props.favIndex, group.groupId),
							};
											...
											Flux.connectStores(
												...
												React.createElement(Fav, {
													...
													moveLeft: () =>
														props.move(
															favIndex,
															(favIndex + props.favs.length - 1) %
																props.favs.length,
														),
													moveRight: () =>
														props.move(
															favIndex,
															(favIndex + 1) % props.favs.length,
														),
							...
							props.tabs.map((tab, tabIndex) =>
								React.createElement(
									Flux.connectStores(
										...
										() => ({
											unreadCount: UnreadStateStore.getUnreadCount(
												tab.channelId,
											),
											unreadEstimated: UnreadStateStore.isEstimated(
												tab.channelId,
											),
											hasUnread: UnreadStateStore.hasUnread(tab.channelId),
											mentionCount: UnreadStateStore.getMentionCount(
												tab.channelId,
											),
					...
					const TopBar = class TopBar extends React.Component {
						...
						closeTab(tabIndex, mode) {
							...
							if (mode === "single" || mode == null) {
								this.setState(
									{
										tabs: this.state.tabs.filter(
											(tab, index) => index !== tabIndex,
										),
										selectedTabIndex: Math.max(
											0,
									...
									() => {
										if (
											!this.state.tabs[this.state.selectedTabIndex].selected
										) {
						...
						moveFav(fromIndex, toIndex) {
							if (fromIndex === toIndex) return;
							const favs = this.state.favs.filter(
								(fav, index) => index !== fromIndex,
							);
							...
							return React.createElement(
								...
								!this.state.showTabBar
									...
									: React.createElement(TabBar, {
											...
											showActiveTabUnreadBadges:
												this.state.showActiveTabUnreadBadges,
											showActiveTabMentionBadges:
												this.state.showActiveTabMentionBadges,
											showActiveTabTypingBadge:
												this.state.showActiveTabTypingBadge,
											showEmptyActiveTabBadges:
												this.state.showEmptyActiveTabBadges,
								...
								!this.state.showFavBar
									...
									: React.createElement(FavBar, {
											...
											radialStatusMode: this.state.radialStatusMode,
											showFavGroupUnreadBadges:
												this.state.showFavGroupUnreadBadges,
											showFavGroupMentionBadges:
												this.state.showFavGroupMentionBadges,
											showFavGroupTypingBadge:
												this.state.showFavGroupTypingBadge,
											showEmptyFavGroupBadges:
												this.state.showEmptyFavGroupBadges,
					...
					return class ChannelTabs extends Plugin {
						...
						onStart(isRetry = false) {
							...
							if (!UserStore.getCurrentUser())
								return setTimeout(() => this.onStart(true), 1000);
					...
					*/
					`;
						...
						async patchAppView(promiseState) {
							const AppView = await ReactComponents.getComponent(
								"Shakeable",
								`.${TopbarSelector.app}`,
							);
							if (promiseState.cancelled) return;
							Patcher.after(
								AppView.component.prototype,
								"render",
								(thisObject, _, returnValue) => {
									returnValue.props.children = [
										React.createElement(TopBar, {
											...
											showActiveTabUnreadBadges:
												this.settings.showActiveTabUnreadBadges,
											showActiveTabMentionBadges:
												this.settings.showActiveTabMentionBadges,
											showActiveTabTypingBadge:
												this.settings.showActiveTabTypingBadge,
											showEmptyActiveTabBadges:
												this.settings.showEmptyActiveTabBadges,
											showFavGroupUnreadBadges:
												this.settings.showFavGroupUnreadBadges,
											showFavGroupMentionBadges:
												this.settings.showFavGroupMentionBadges,
											showFavGroupTypingBadge:
												this.settings.showFavGroupTypingBadge,
											showEmptyFavGroupBadges:
												this.settings.showEmptyFavGroupBadges,
						...
						patchContextMenus() {
							patches.push(
								ContextMenu.patch("channel-context", (returnValue, props) => {
									if (!this.settings.showTabBar && !this.settings.showFavBar)
										return;
						...
						loadSettings() {
							if (
								Object.keys(Utilities.loadSettings(this.getSettingsPath()))
									.length === 0
							) {
								this.settings = Utilities.loadSettings(
									this.getSettingsPath(true),
						...
						getSettingsPanel() {
							...
							new Settings.SettingGroup("Startup Settings", { shown: true })
								.appendTo(panel)
								.append(
									new Settings.Switch(
										"Reopen last channel",
										"When starting the plugin (or discord) the channel will be selected again instead of the friends page",
										this.settings.reopenLastChannel,
										(checked) => {
							...
							new Settings.SettingGroup("General Appearance")
								.appendTo(panel)
								.append(
									new Settings.Switch(
										"Show Tab Bar",
										"Allows you to have multiple tabs like in a web browser",
										this.settings.showTabBar,
										(checked) => {
								...
								.append(
									new Settings.Switch(
										"Show Fav Bar",
										"Allows you to add favorites by right clicking a tab or the fav bar",
										this.settings.showFavBar,
										(checked) => {
								...
								.append(
									new Settings.Switch(
										"Show Quick Settings",
										"Allows you to quickly change major settings from a context menu",
										this.settings.showQuickSettings,
										(checked) => {
								...
								.append(
									new Settings.Switch(
										...
										"Click to go the left or right tab, this behavior can be changed in Behavior settings",
										this.settings.showNavButtons,
										(checked) => {
								...
								.append(
									new Settings.Switch(
										"Enable Privacy Mode",
										"Obfusicates all the Sensitive Text in ChannelTabs",
								...
								.append(
									new Settings.Switch(
										"Use Radial Status Indicators",
										"Changes the status indicator into a circular border",
										this.settings.radialStatusMode,
										(checked) => {
							...
							new Settings.SettingGroup("Behavior")
								.appendTo(panel)

								.append(
									new Settings.Switch(
										"Always Auto Focus New Tabs",
										"Forces all newly created tabs to bring themselves to focus",
										this.settings.alwaysFocusNewTabs,
										(checked) => {
								...
								.append(
									new Settings.Switch(
										"Primary Forward/Back Navigation",
										"Instead of scrolling down the row, use the previous and next buttons to navigate between pages",
										this.settings.useStandardNav,
										(checked) => {
							...
							new Settings.SettingGroup("Badge Visibility - Favorites")
								.appendTo(panel)
								...
								.append(
									new Settings.Switch(
										"Show Unread",
										"",
										this.settings.showFavUnreadBadges,
										(checked) => {
								...
								.append(
									new Settings.Switch(
										"Show Mentions",
										"",
										this.settings.showFavMentionBadges,
										(checked) => {
								...
								.append(
									new Settings.Switch(
										"Show Typing",
										"",
										this.settings.showFavTypingBadge,
										(checked) => {
								...
								.append(
									new Settings.Switch(
										"Show Empty",
										"",
										this.settings.showEmptyFavBadges,
										(checked) => {
							...
							new Settings.SettingGroup("Badge Visibility - Favorite Groups")
								.appendTo(panel)
								...
								.append(
									new Settings.Switch(
										"Show Empty",
										"",
										this.settings.showEmptyGroupFavBadges,
										(checked) => {
							...
							new Settings.SettingGroup("Badge Visibility - Tabs")
								.appendTo(panel)
								...
								.append(
									new Settings.Switch(
										"Show Unread",
										"",
										this.settings.showTabUnreadBadges,
										(checked) => {
								...
								.append(
									new Settings.Switch(
										"Show Mentions",
										"",
										this.settings.showTabMentionBadges,
										(checked) => {
								...
								.append(
									new Settings.Switch(
										"Show Typing",
										"",
										this.settings.showTabTypingBadge,
										(checked) => {
								...
								.append(
									new Settings.Switch(
										"Show Empty",
										"",
										this.settings.showEmptyTabBadges,
										(checked) => {
							...
							new Settings.SettingGroup("Badge Visibility - Active Tabs")
								.appendTo(panel)
